...
const TestimonialCard = ({ quote, author }: any) => (
  <div className="bg-white border rounded-lg shadow-md hover:shadow-lg transition duration-300 p-6">
...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <header className="  py-5  sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 z-20 shadow-md shadow-secondary  sm:px-2">
        <div className="container px-3 mx-auto flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold text-blue-600">
            DefiVerse
          </Link>
          <nav className="space-x-4 font-semibold ">
            <Link href="#features" className="text-gray-600 hover:text-blue-600 font-semibold transition-colors">
              Features
            </Link>
      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <Link
              ...
              className="inline-block bg-blue-600 hover:bg-blue-700 font-medium text-white px-6 py-3 rounded-full transition duration-300"
            >
              Start Learning
            </Link>
          </motion.div>
        ...
        <section id="testimonials" className="container mx-auto px-4 py-10">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <Link
            href="/dashboard/courses"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full transition duration-300"
          >
            Get Started Now
          </Link>
        </section>
